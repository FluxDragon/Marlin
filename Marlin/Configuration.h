...
#define STRING_CONFIG_H_AUTHOR "(KOR, 230325)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SKR-3-kenre"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 408.16 }
